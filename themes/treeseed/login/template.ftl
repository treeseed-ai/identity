<#-- Based on Keycloak 26.7.3 template.ftl, Apache-2.0. Keep native authentication/session behavior. -->
  ...
  <div class="${properties.kcLoginContainer!}">
    <header id="kc-header" class="pf-v5-c-login__header">
      <div id="kc-header-wrapper"
              class="pf-v5-c-brand"><img class="auth-brand__mark" src="${url.resourcesPath}/img/treeseed-logo.svg" alt="" width="72" height="72"><span class="auth-brand__name">TreeSeed</span><span class="auth-brand__tag">${msg("treeseedTagline")}</span></div>
    </header>
